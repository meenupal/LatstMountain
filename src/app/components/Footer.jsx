...
export default function Footer() {
  return (
    <>
      <footer className="bg-blue-950 text-gray-200 py-8 px-6 md:px-20">
        ...
        <div className="sticky top-16 z-50 flex justify-start mt-6  md:justify-center px-4">
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="flex items-center gap-2 bg-white text-blue-700 px-4 py-2 rounded-lg shadow-md hover:bg-blue-600 hover:text-white transition-all duration-300 ease-in-out"
            title="Chat with us on WhatsApp"
          >
