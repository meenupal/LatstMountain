...
const blogPosts = [
  {
    ...
    description:
      "Explore the ultimate Himalayan trekking guide with routes, safety tips, and local experiences.",
    category: "Trekking",
    date: "April 1, 2025",
    readTime: "9 min read",
    image: "/deal6.webp",
  ...
  },
  {
    ...
    description:
      "Discover breathtaking mountain locations perfect for your next weekend getaway or long trip.",
    category: "Travel",
    date: "March 25, 2025",
    readTime: "6 min read",
    image: "/deal32.webp",
  ...
  },
  {
    ...
    description:
      "Everything you need for a safe and fun mountain camping experience—from tents to tech.",
    category: "Camping",
    date: "March 10, 2025",
    readTime: "7 min read",
    image: "/deal31.webp",
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <div
        ...
        style={{
          backgroundImage: "url('deal26.webp')",
        }}
      >
        ...
        <div className="max-w-6xl mx-auto text-center z-10 relative">
          ...
          <p className="text-xl md:text-2xl opacity-90 max-w-2xl mx-auto mb-8">
            Your guide to the best mountain destinations, adventures & travel
            tips
          </p>
      ...
      <section className="bg-white py-16 px-4">
        <div className="max-w-3xl mx-auto text-center bg-gray-50 shadow-xl rounded-2xl p-10">
          ...
          <p className="text-gray-600 mb-6">
            Get travel guides, mountain tips, and destination ideas straight to
            your inbox
          </p>
